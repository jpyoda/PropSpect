...
const HomePage = () => {
  ...
  // ¿Dame apartamentos en bogota estrato seis?
  // ¿Dame casas en bogota estrato 5?
  // ¿Lotes comercial en el barrio Tintala?
  // ¿Barrio la calera estrato rural?
      ...
      inmuebles: z
        .array(
          z.object({
            ...
            barrio: z.string(),
            direccion: z.string().describe("The address of the inmueble item"),
